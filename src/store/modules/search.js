...
const search = {
    ...
    mutations: {
        ...
        [types.SET_SEARCH_CONTEXT](state,value){
            state.searchContext = value;
        },
        [types.SET_SEARCH_LOADING_FLAG](state,value){
    ...
    actions: {
        ...
        setSearchContext({commit},value){
            commit(types.SET_SEARCH_CONTEXT,value);
        },
